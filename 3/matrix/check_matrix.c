...
#define ASSERT_TRUE(actual) EXPECT_TRUE(actual); if (!*success) return
...
#define ASSERT_FALSE(actual) EXPECT_FALSE(actual); if (!*success) return
...
#define ASSERT_EQUAL(expected, actual) EXPECT_EQUAL(expected, actual); if (!*success) return
